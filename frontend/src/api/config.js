...
export const SEARCH_API_BASE =  process.env.REACT_APP_EXPRESS_API_BASE || 'https://localhost:5000/api'

export const SEARCH_API_BASE_STATUS =  process.env.REACT_APP_EXPRESS_SERVER_CHECK_API_BASE || 'https://localhost:5000'
